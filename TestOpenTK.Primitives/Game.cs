...
namespace TestOpenTK.Primitives
{
    internal class Game : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, triangleVertices.Length * sizeof(float), triangleVertices,
            ...
            //  Which vertex attribute we want to configure. We set it in "(location = 0)"
            ...
            GL.EnableVertexAttribArray(shader.GetAttribLocation("aPosition"));  //Activating vertex attribute. We set it in "(location = 0)"
            #endregion
            #region EBO
            ebo = GL.GenBuffer();
            GL.BindBuffer(BufferTarget.ElementArrayBuffer, ebo);
            GL.BufferData(BufferTarget.ElementArrayBuffer, triangleIndices.Length * sizeof(float), triangleIndices,
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            GL.DrawElements(BeginMode.Triangles, triangleIndices.Length, DrawElementsType.UnsignedInt, 0);
